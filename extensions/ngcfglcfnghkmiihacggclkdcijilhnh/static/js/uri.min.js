...
for(l=0;l<b;l++){for(var d=g[l].split(""),k=0;3>k;k++)if("0"===d[0]&&1<d.length)d.splice(0,1);else break;g[l]=d.join("")}var d=-1,q=k=0,t=-1,n=!1;for(l=0;l<b;l++)n?"0"===g[l]?q+=1:(n=!1,q>k&&(d=t,k=q)):"0"===g[l]&&(n=!0,t=l,q=1);q>k&&(d=t,k=q);1<k&&g.splice(d,k,"");d=g.length;b="";""===g[0]&&(b=":");for(l=0;l<d;l++){b+=g[l];if(l===d-1)break;b+=":"}""===g[d-1]&&(b+=":");return b},noConflict:function(){d.IPv6===this&&(d.IPv6=k);return this}}});
(function(d){function k(b){throw new RangeError(f[b]);}function g(b,f){for(var d=b.length,h=[];d--;)h[d]=f(b[d]);return h}function u(b,f){var d=b.split("@"),h="";1<d.length&&(h=d[0]+"@",b=d[1]);b=b.replace(y,".");d=b.split(".");d=g(d,f).join(".");return h+d}function b(b){for(var f=[],d=0,h=b.length,g,a;d<h;)g=b.charCodeAt(d++),55296<=g&&56319>=g&&d<h?(a=b.charCodeAt(d++),56320==(a&64512)?f.push(((g&1023)<<10)+(a&1023)+65536):(f.push(g),d--)):f.push(g);return f}function l(b){return g(b,function(b){var f=
"";65535<b&&(b-=65536,f+=z(b>>>10&1023|55296),b=56320|b&1023);return f+=z(b)}).join("")}function A(b,f){return b+22+75*(26>b)-((0!=f)<<5)}function q(b,f,d){var h=0;b=d?v(b/700):b>>1;for(b+=v(b/f);455<b;h+=36)b=v(b/35);return v(h+36*b/(b+38))}function t(b){var f=[],d=b.length,h,g=0,a=128,c=72,e,r,x,w,t;e=b.lastIndexOf("-");0>e&&(e=0);for(r=0;r<e;++r)128<=b.charCodeAt(r)&&k("not-basic"),f.push(b.charCodeAt(r));for(e=0<e?e+1:0;e<d;){r=g;h=1;for(x=36;;x+=36){e>=d&&k("invalid-input");w=b.charCodeAt(e++);
w=10>w-48?w-22:26>w-65?w-65:26>w-97?w-97:36;(36<=w||w>v((2147483647-g)/h))&&k("overflow");g+=w*h;t=x<=c?1:x>=c+26?26:x-c;if(w<t)break;w=36-t;h>v(2147483647/w)&&k("overflow");h*=w}h=f.length+1;c=q(g-r,h,0==r);v(g/h)>2147483647-a&&k("overflow");a+=v(g/h);g%=h;f.splice(g++,0,a)}return l(f)}function n(f){var d,h,g,t,a,c,e,r,x,w=[],m,p,n;f=b(f);m=f.length;d=128;h=0;a=72;for(c=0;c<m;++c)x=f[c],128>x&&w.push(z(x));for((g=t=w.length)&&w.push("-");g<m;){e=2147483647;for(c=0;c<m;++c)x=f[c],x>=d&&x<e&&(e=x);
p=g+1;e-d>v((2147483647-h)/p)&&k("overflow");h+=(e-d)*p;d=e;for(c=0;c<m;++c)if(x=f[c],x<d&&2147483647<++h&&k("overflow"),x==d){r=h;for(e=36;;e+=36){x=e<=a?1:e>=a+26?26:e-a;if(r<x)break;n=r-x;r=36-x;w.push(z(A(x+n%r,0)));r=v(n/r)}w.push(z(A(r,0)));a=q(h,p,g==t);h=0;++g}++h;++d}return w.join("")}var B="object"==typeof exports&&exports&&!exports.nodeType&&exports,h="object"==typeof module&&module&&!module.nodeType&&module,m="object"==typeof global&&global;if(m.global===m||m.window===m||m.self===m)d=
m;var p,D=/^xn--/,E=/[^\x20-\x7E]/,y=/[\x2E\u3002\uFF0E\uFF61]/g,f={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},v=Math.floor,z=String.fromCharCode,C;p={version:"1.3.2",ucs2:{decode:b,encode:l},decode:t,encode:n,toASCII:function(b){return u(b,function(b){return E.test(b)?"xn--"+n(b):b})},toUnicode:function(b){return u(b,function(b){return D.test(b)?t(b.slice(4).toLowerCase()):b})}};if("function"==
typeof define&&"object"==typeof define.amd&&define.amd)define("punycode",function(){return p});else if(B&&h)if(module.exports==B)h.exports=p;else for(C in p)p.hasOwnProperty(C)&&(B[C]=p[C]);else d.punycode=p})(this);
...
var k=d.lastIndexOf(".",b-1);if(0>=k||k>=b-1)return!1;var u=g.list[d.slice(b+1)];return u?0<=u.indexOf(" "+d.slice(k+1,b)+" "):!1},is:function(d){var b=d.lastIndexOf(".");if(0>=b||b>=d.length-1||0<=d.lastIndexOf(".",b-1))return!1;var k=g.list[d.slice(b+1)];return k?0<=k.indexOf(" "+d.slice(0,b)+" "):!1},get:function(d){var b=d.lastIndexOf(".");if(0>=b||b>=d.length-1)return null;var k=d.lastIndexOf(".",b-1);if(0>=k||k>=b-1)return null;var u=g.list[d.slice(b+1)];return!u||0>u.indexOf(" "+d.slice(k+
1,b)+" ")?null:d.slice(k+1)},noConflict:function(){d.SecondLevelDomains===this&&(d.SecondLevelDomains=k);return this}};return g});
(function(d,k){"object"===typeof module&&module.exports?module.exports=k(require("./punycode"),require("./IPv6"),require("./SecondLevelDomains")):"function"===typeof define&&define.amd?define(["./punycode","./IPv6","./SecondLevelDomains"],k):d.URI=k(d.punycode,d.IPv6,d.SecondLevelDomains,d)})(this,function(d,k,g,u){function b(a,c){var e=1<=arguments.length,r=2<=arguments.length;if(!(this instanceof b))return e?r?new b(a,c):new b(a):new b;if(void 0===a){if(e)throw new TypeError("undefined is not a valid argument for URI");
a="undefined"!==typeof location?location.href+"":""}this.href(a);return void 0!==c?this.absoluteTo(c):this}function l(a){return a.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function A(a){return void 0===a?"Undefined":String(Object.prototype.toString.call(a)).slice(8,-1)}function q(a){return"Array"===A(a)}function t(a,c){var e={},b,d;if("RegExp"===A(c))e=null;else if(q(c))for(b=0,d=c.length;b<d;b++)e[c[b]]=!0;else e[c]=!0;b=0;for(d=a.length;b<d;b++)if(e&&void 0!==e[a[b]]||!e&&c.test(a[b]))a.splice(b,
1),d--,b--;return a}function n(a,c){var e,b;if(q(c)){e=0;for(b=c.length;e<b;e++)if(!n(a,c[e]))return!1;return!0}var d=A(c);e=0;for(b=a.length;e<b;e++)if("RegExp"===d){if("string"===typeof a[e]&&a[e].match(c))return!0}else if(a[e]===c)return!0;return!1}function B(a,c){if(!q(a)||!q(c)||a.length!==c.length)return!1;a.sort();c.sort();for(var e=0,b=a.length;e<b;e++)if(a[e]!==c[e])return!1;return!0}function h(a){return a.replace(/^\/+|\/+$/g,"")}function m(a){return escape(a)}function p(a){return encodeURIComponent(a).replace(/[!'()*]/g,
m).replace(/\*/g,"%2A")}function D(a){return function(c,e){if(void 0===c)return this._parts[a]||"";this._parts[a]=c||null;this.build(!e);return this}}function E(a,c){return function(e,b){if(void 0===e)return this._parts[a]||"";null!==e&&(e+="",e.charAt(0)===c&&(e=e.substring(1)));this._parts[a]=e;this.build(!b);return this}}var y=u&&u.URI;b.version="1.18.4";var f=b.prototype,v=Object.prototype.hasOwnProperty;b._parts=function(){return{protocol:null,username:null,password:null,hostname:null,urn:null,
...
gopher:"70",ws:"80",wss:"443"};b.invalid_hostname_characters=/[^a-zA-Z0-9\.-]/;b.domAttributes={a:"href",blockquote:"cite",link:"href",base:"href",script:"src",form:"action",img:"src",area:"href",iframe:"src",embed:"src",source:"src",track:"src",input:"src",audio:"src",video:"src"};b.getDomAttribute=function(a){if(a&&a.nodeName){var c=a.nodeName.toLowerCase();if("input"!==c||"image"===a.type)return b.domAttributes[c]}};b.encode=p;b.decode=decodeURIComponent;b.iso8859=function(){b.encode=escape;b.decode=
unescape};b.unicode=function(){b.encode=p;b.decode=decodeURIComponent};b.characters={pathname:{encode:{expression:/%(24|26|2B|2C|3B|3D|3A|40)/ig,map:{"%24":"$","%26":"&","%2B":"+","%2C":",","%3B":";","%3D":"=","%3A":":","%40":"@"}},decode:{expression:/[\/\?#]/g,map:{"/":"%2F","?":"%3F","#":"%23"}}},reserved:{encode:{expression:/%(21|23|24|26|27|28|29|2A|2B|2C|2F|3A|3B|3D|3F|40|5B|5D)/ig,map:{"%3A":":","%2F":"/","%3F":"?","%23":"#","%5B":"[","%5D":"]","%40":"@","%21":"!","%24":"$","%26":"&","%27":"'",
...
(c=b.escapeQuerySpace);try{return b.decode(c?a.replace(/\+/g,"%20"):a)}catch(e){return a}};var z={encode:"encode",decode:"decode"},C,F=function(a,c){return function(e){try{return b[c](e+"").replace(b.characters[a][c].expression,function(e){return b.characters[a][c].map[e]})}catch(r){return e}}};for(C in z)b[C+"PathSegment"]=F("pathname",z[C]),b[C+"UrnPathSegment"]=F("urnpath",z[C]);z=function(a,c,e){return function(r){var d;d=e?function(a){return b[c](b[e](a))}:b[c];r=(r+"").split(a);for(var f=0,
h=r.length;f<h;f++)r[f]=d(r[f]);return r.join(a)}};b.decodePath=z("/","decodePathSegment");b.decodeUrnPath=z(":","decodeUrnPathSegment");b.recodePath=z("/","encodePathSegment","decode");b.recodeUrnPath=z(":","encodeUrnPathSegment","decode");b.encodeReserved=F("reserved","encode");b.parse=function(a,c){var e;c||(c={});e=a.indexOf("#");-1<e&&(c.fragment=a.substring(e+1)||null,a=a.substring(0,e));e=a.indexOf("?");-1<e&&(c.query=a.substring(e+1)||null,a=a.substring(0,e));"//"===a.substring(0,2)?(c.protocol=
...
var d=e.start||b.findUri.start,f=e.end||b.findUri.end,h=e.trim||b.findUri.trim,g=e.parens||b.findUri.parens,t=/[a-z0-9-]=["']?$/i;for(d.lastIndex=0;;){var k=d.exec(a);if(!k)break;k=k.index;if(e.ignoreHtml){var m=a.slice(Math.max(k-3,0),k);if(m&&t.test(m))continue}for(var p=k+a.slice(k).search(f),m=a.slice(k,p),p=-1;;){var n=g.exec(m);if(!n)break;p=Math.max(p,n.index+n[0].length)}m=-1<p?m.slice(0,p)+m.slice(p+1).replace(h,""):m.replace(h,"");e.ignore&&e.ignore.test(m)||(p=k+m.length,m=c(m,k,p,a),void 0===
m?d.lastIndex=p:(m=String(m),a=a.slice(0,k)+m+a.slice(p),d.lastIndex=k+m.length))}d.lastIndex=0;return a};b.ensureValidHostname=function(a){if(a.match(b.invalid_hostname_characters)){if(!d)throw new TypeError('Hostname "'+a+'" contains characters other than [A-Z0-9.-] and Punycode.js is not available');if(d.toASCII(a).match(b.invalid_hostname_characters))throw new TypeError('Hostname "'+a+'" contains characters other than [A-Z0-9.-]');}};b.noConflict=function(a){if(a)return a={URI:this.noConflict()},
u.URITemplate&&"function"===typeof u.URITemplate.noConflict&&(a.URITemplate=u.URITemplate.noConflict()),u.IPv6&&"function"===typeof u.IPv6.noConflict&&(a.IPv6=u.IPv6.noConflict()),u.SecondLevelDomains&&"function"===typeof u.SecondLevelDomains.noConflict&&(a.SecondLevelDomains=u.SecondLevelDomains.noConflict()),a;u.URI===this&&(u.URI=y);return this};f.build=function(a){if(!0===a)this._deferred_build=!0;else if(void 0===a||this._deferred_build)this._string=b.build(this._parts),this._deferred_build=
!1;return this};f.clone=function(){return new b(this)};f.valueOf=f.toString=function(){return this.build(!1)._string};f.protocol=D("protocol");f.username=D("username");f.password=D("password");f.hostname=D("hostname");f.port=D("port");f.query=E("query","?");f.fragment=E("fragment","#");f.search=function(a,c){var e=this.query(a,c);return"string"===typeof e&&e.length?"?"+e:e};f.hash=function(a,c){var e=this.fragment(a,c);return"string"===typeof e&&e.length?"#"+e:e};f.pathname=function(a,c){if(void 0===
a||!0===a){var e=this._parts.path||(this._parts.hostname?"/":"");return a?(this._parts.urn?b.decodeUrnPath:b.decodePath)(e):e}this._parts.path=this._parts.urn?a?b.recodeUrnPath(a):"":a?b.recodePath(a):"/";this.build(!c);return this};f.path=f.pathname;f.href=function(a,c){var e;if(void 0===a)return this.toString();this._string="";this._parts=b._parts();var d=a instanceof b,f="object"===typeof a&&(a.hostname||a.path||a.pathname);a.nodeName&&(f=b.getDomAttribute(a),a=a[f]||"",f=!1);!d&&f&&void 0!==a.pathname&&
(a=a.toString());if("string"===typeof a||a instanceof String)this._parts=b.parse(String(a),this._parts);else if(d||f)for(e in d=d?a._parts:a,d)v.call(this._parts,e)&&(this._parts[e]=d[e]);else throw new TypeError("invalid input");this.build(!c);return this};f.is=function(a){var c=!1,e=!1,d=!1,f=!1,h=!1,m=!1,k=!1,t=!this._parts.urn;this._parts.hostname&&(t=!1,e=b.ip4_expression.test(this._parts.hostname),d=b.ip6_expression.test(this._parts.hostname),c=e||d,h=(f=!c)&&g&&g.has(this._parts.hostname),
m=f&&b.idn_expression.test(this._parts.hostname),k=f&&b.punycode_expression.test(this._parts.hostname));switch(a.toLowerCase()){case "relative":return t;case "absolute":return!t;case "domain":case "name":return f;case "sld":return h;case "ip":return c;case "ip4":case "ipv4":case "inet4":return e;case "ip6":case "ipv6":case "inet6":return d;case "idn":return m;case "url":return!this._parts.urn;case "urn":return!!this._parts.urn;case "punycode":return k}return null};var G=f.protocol,H=f.port,I=f.hostname;
...
g.is(a))e=new RegExp(l(this.tld())+"$"),this._parts.hostname=this._parts.hostname.replace(e,a);else throw new TypeError('TLD "'+a+'" contains characters other than [A-Z0-9]');else{if(!this._parts.hostname||this.is("IP"))throw new ReferenceError("cannot set TLD on non-domain host");e=new RegExp(l(this.tld())+"$");this._parts.hostname=this._parts.hostname.replace(e,a)}else throw new TypeError("cannot set TLD empty");this.build(!c);return this};f.directory=function(a,c){if(this._parts.urn)return void 0===
...
null,this.build(!a));return this};f.normalizeFragment=function(a){this._parts.fragment||(this._parts.fragment=null,this.build(!a));return this};f.normalizeSearch=f.normalizeQuery;f.normalizeHash=f.normalizeFragment;f.iso8859=function(){var a=b.encode,c=b.decode;b.encode=escape;b.decode=decodeURIComponent;try{this.normalize()}finally{b.encode=a,b.decode=c}return this};f.unicode=function(){var a=b.encode,c=b.decode;b.encode=p;b.decode=unescape;try{this.normalize()}finally{b.encode=a,b.decode=c}return this};
f.readable=function(){var a=this.clone();a.username("").password("").normalize();var c="";a._parts.protocol&&(c+=a._parts.protocol+"://");a._parts.hostname&&(a.is("punycode")&&d?(c+=d.toUnicode(a._parts.hostname),a._parts.port&&(c+=":"+a._parts.port)):c+=a.host());a._parts.hostname&&a._parts.path&&"/"!==a._parts.path.charAt(0)&&(c+="/");c+=a.path(!0);if(a._parts.query){for(var e="",f=0,h=a._parts.query.split("&"),g=h.length;f<g;f++){var m=(h[f]||"").split("="),e=e+("&"+b.decodeQuery(m[0],this._parts.escapeQuerySpace).replace(/&/g,
"%26"));void 0!==m[1]&&(e+="="+b.decodeQuery(m[1],this._parts.escapeQuerySpace).replace(/&/g,"%26"))}c+="?"+e.substring(1)}return c+=b.decodeQuery(a.hash(),!0)};f.absoluteTo=function(a){var c=this.clone(),e=["protocol","username","password","hostname","port"],d,f;if(this._parts.urn)throw Error("URNs do not have any generally defined hierarchical components");a instanceof b||(a=new b(a));c._parts.protocol||(c._parts.protocol=a._parts.protocol);if(this._parts.hostname)return c;for(d=0;f=e[d];d++)c._parts[f]=
...
d=d.path.substring(f.length).replace(/[^\/]*$/,"").replace(/.*?\//g,"../");e.path=d+e.path.substring(f.length)||"./";return c.build()};f.equals=function(a){var c=this.clone(),e=new b(a),d;a={};var f,h;c.normalize();e.normalize();if(c.toString()===e.toString())return!0;f=c.query();d=e.query();c.query("");e.query("");if(c.toString()!==e.toString()||f.length!==d.length)return!1;c=b.parseQuery(f,this._parts.escapeQuerySpace);d=b.parseQuery(d,this._parts.escapeQuerySpace);for(h in c)if(v.call(c,h)){if(!q(c[h])){if(c[h]!==
d[h])return!1}else if(!B(c[h],d[h]))return!1;a[h]=!0}for(h in d)if(v.call(d,h)&&!a[h])return!1;return!0};f.duplicateQueryParameters=function(a){this._parts.duplicateQueryParameters=!!a;return this};f.escapeQuerySpace=function(a){this._parts.escapeQuerySpace=!!a;return this};return b});
(function(d,k){"object"===typeof module&&module.exports?module.exports=k(require("./URI")):"function"===typeof define&&define.amd?define(["./URI"],k):d.URITemplate=k(d.URI,d)})(this,function(d,k){function g(b){if(g._cache[b])return g._cache[b];if(!(this instanceof g))return new g(b);this.expression=b;g._cache[b]=this;return this}function u(b){this.data=b;this.cache={}}var b=k&&k.URITemplate,l=Object.prototype.hasOwnProperty,A=g.prototype,q={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,
encode:"encode"},"+":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},"#":{prefix:"#",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},".":{prefix:".",separator:".",named:!1,empty_name_separator:!1,encode:"encode"},"/":{prefix:"/",separator:"/",named:!1,empty_name_separator:!1,encode:"encode"},";":{prefix:";",separator:";",named:!0,empty_name_separator:!1,encode:"encode"},"?":{prefix:"?",separator:"&",named:!0,empty_name_separator:!0,encode:"encode"},
"&":{prefix:"&",separator:"&",named:!0,empty_name_separator:!0,encode:"encode"}};g._cache={};g.EXPRESSION_PATTERN=/\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g;g.VARIABLE_PATTERN=/^([^*:.](?:\.?[^*:.])*)((\*)|:(\d+))?$/;g.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_.]/;g.LITERAL_PATTERN=/[<>{}'"`^| \\]/;g.expand=function(b,d){var k=q[b.operator],h=k.named?"Named":"Unnamed",m=b.variables,p=[],t,n,l;for(l=0;n=m[l];l++)if(t=d.get(n.name),t.val.length){if(1<t.type&&n.maxlength)throw Error('Invalid expression: Prefix modifier not applicable to variable "'+
n.name+'"');p.push(g["expand"+h](t,k,n.explode,n.explode&&k.separator||",",n.maxlength,n.name))}else t.type&&p.push("");return p.length?k.prefix+p.join(k.separator):""};g.expandNamed=function(b,g,k,h,m,p){var t="",n=g.encode;g=g.empty_name_separator;var l=!b[n].length,f=2===b.type?"":d[n](p),v,q,B;q=0;for(B=b.val.length;q<B;q++)m?(v=d[n](b.val[q][1].substring(0,m)),2===b.type&&(f=d[n](b.val[q][0].substring(0,m)))):l?(v=d[n](b.val[q][1]),2===b.type?(f=d[n](b.val[q][0]),b[n].push([f,v])):b[n].push([void 0,
v])):(v=b[n][q][1],2===b.type&&(f=b[n][q][0])),t&&(t+=h),k?t+=f+(g||v?"=":"")+v:(q||(t+=d[n](p)+(g||v?"=":"")),2===b.type&&(t+=f+","),t+=v);return t};g.expandUnnamed=function(b,g,k,h,m){var p="",n=g.encode;g=g.empty_name_separator;var t=!b[n].length,q,f,l,B;l=0;for(B=b.val.length;l<B;l++)m?f=d[n](b.val[l][1].substring(0,m)):t?(f=d[n](b.val[l][1]),b[n].push([2===b.type?d[n](b.val[l][0]):void 0,f])):f=b[n][l][1],p&&(p+=h),2===b.type&&(q=m?d[n](b.val[l][0].substring(0,m)):b[n][l][0],p+=q,p=k?p+(g||f?
"=":""):p+","),p+=f;return p};g.noConflict=function(){k.URITemplate===g&&(k.URITemplate=b);return g};A.expand=function(b){var d="";this.parts&&this.parts.length||this.parse();b instanceof u||(b=new u(b));for(var k=0,h=this.parts.length;k<h;k++)d+="string"===typeof this.parts[k]?this.parts[k]:g.expand(this.parts[k],b);return d};A.parse=function(){var b=this.expression,d=g.EXPRESSION_PATTERN,k=g.VARIABLE_PATTERN,h=g.VARIABLE_NAME_PATTERN,m=g.LITERAL_PATTERN,p=[],l=0,u,y,f,v=function(b){if(b.match(m))throw Error('Invalid Literal "'+
b+'"');return b};for(d.lastIndex=0;;){y=d.exec(b);if(null===y){p.push(v(b.substring(l)));break}else p.push(v(b.substring(l,y.index))),l=y.index+y[0].length;if(!q[y[1]])throw Error('Unknown Operator "'+y[1]+'" in "'+y[0]+'"');if(!y[3])throw Error('Unclosed Expression "'+y[0]+'"');u=y[2].split(",");for(var z=0,A=u.length;z<A;z++){f=u[z].match(k);if(null===f)throw Error('Invalid Variable "'+u[z]+'" in "'+y[0]+'"');if(f[1].match(h))throw Error('Invalid Variable Name "'+f[1]+'" in "'+y[0]+'"');u[z]={name:f[1],
explode:!!f[3],maxlength:f[4]&&parseInt(f[4],10)}}if(!u.length)throw Error('Expression Missing Variable(s) "'+y[0]+'"');p.push({expression:y[0],operator:y[1],variables:u})}p.length||p.push(v(b));this.parts=p;return this};u.prototype.get=function(b){var d=this.data,g={type:0,val:[],encode:[],encodeReserved:[]},h;if(void 0!==this.cache[b])return this.cache[b];this.cache[b]=g;d="[object Function]"===String(Object.prototype.toString.call(d))?d(b):"[object Function]"===String(Object.prototype.toString.call(d[b]))?
d[b](b):d[b];if(void 0!==d&&null!==d)if("[object Array]"===String(Object.prototype.toString.call(d))){h=0;for(b=d.length;h<b;h++)void 0!==d[h]&&null!==d[h]&&g.val.push([void 0,String(d[h])]);g.val.length&&(g.type=3)}else if("[object Object]"===String(Object.prototype.toString.call(d))){for(h in d)l.call(d,h)&&void 0!==d[h]&&null!==d[h]&&g.val.push([h,String(d[h])]);g.val.length&&(g.type=2)}else g.type=1,g.val.push([void 0,String(d)]);return g};d.expand=function(b,k){var l=(new g(b)).expand(k);return new d(l)};
return g});
(function(d,k){"object"===typeof module&&module.exports?module.exports=k(require("jquery"),require("./URI")):"function"===typeof define&&define.amd?define(["jquery","./URI"],k):k(d.jQuery,d.URI)})(this,function(d,k){function g(b){return b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function u(b){var d=b.nodeName.toLowerCase();if("input"!==d||"image"===b.type)return k.domAttributes[d]}function b(b){return{get:function(h){return d(h).uri()[b]()},set:function(h,g){d(h).uri()[b](g);return g}}}function l(b,
g){var h,k,m;if(!u(b)||!g)return!1;h=g.match(B);if(!h||!h[5]&&":"!==h[2]&&!q[h[2]])return!1;m=d(b).uri();if(h[5])return m.is(h[5]);if(":"===h[2])return k=h[1].toLowerCase()+":",q[k]?q[k](m,h[4]):!1;k=h[1].toLowerCase();return A[k]?q[h[2]](m[k](),h[4],k):!1}var A={},q={"=":function(b,d){return b===d},"^=":function(b,d){return!!(b+"").match(new RegExp("^"+g(d),"i"))},"$=":function(b,d){return!!(b+"").match(new RegExp(g(d)+"$","i"))},"*=":function(b,d,k){"directory"===k&&(b+="/");return!!(b+"").match(new RegExp(g(d),
"i"))},"equals:":function(b,d){return b.equals(d)},"is:":function(b,d){return b.is(d)}};d.each("origin authority directory domain filename fragment hash host hostname href password path pathname port protocol query resource scheme search subdomain suffix tld username".split(" "),function(h,g){A[g]=!0;d.attrHooks["uri:"+g]=b(g)});var t=function(b,g){return d(b).uri().href(g).toString()};d.each(["src","href","action","uri","cite"],function(b,g){d.attrHooks[g]={set:t}});d.attrHooks.uri.get=function(b){return d(b).uri()};
d.fn.uri=function(b){var d=this.first(),g=d.get(0),h=u(g);if(!h)throw Error('Element "'+g.nodeName+'" does not have either property: href, src, action, cite');if(void 0!==b){var l=d.data("uri");if(l)return l.href(b);b instanceof k||(b=k(b||""))}else{if(b=d.data("uri"))return b;b=k(d.attr(h)||"")}b._dom_element=g;b._dom_attribute=h;b.normalize();d.data("uri",b);return b};k.prototype.build=function(b){if(this._dom_element)this._string=k.build(this._parts),this._deferred_build=!1,this._dom_element.setAttribute(this._dom_attribute,
this._string),this._dom_element[this._dom_attribute]=this._string;else if(!0===b)this._deferred_build=!0;else if(void 0===b||this._deferred_build)this._string=k.build(this._parts),this._deferred_build=!1;return this};var n,B=/^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/;n=d.expr.createPseudo?d.expr.createPseudo(function(b){return function(d){return l(d,b)}}):function(b,d,g){return l(b,g[3])};d.expr[":"].uri=n;return d});
