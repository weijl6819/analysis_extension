...
//
//  /* @ngInject */
//  function lcCheckMdInputFocus($timeout, $parse) {
//    return {
//      //scope: true,   // optionally create a child scope
//      link: function (scope, element, attrs) {
//        var model = attrs.mdInputFocusd;
//        //var model = !!$parse(attrs.mdInputFocusd);
//        console.log(model);
...
//    .directive('lcCheckMdInputFocus', ['$timeout', '$parse', lcCheckMdInputFocus]);
//
//}());
//
//
