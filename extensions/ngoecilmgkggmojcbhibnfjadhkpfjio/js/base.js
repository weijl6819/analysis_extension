 ...
 */
var config = {
    destinationSite: "http://j.tvnoop.com",
    verticalSearchEndpoint: "/tv/search/",
    searchDomain: "http://sport.eanswers.com",
    hubDomain: "playmediacenter.com",
    defCid: "6280",
    ga: "UA-105335843-6",
    yLetters: "szds",
    vertical: "sporttv",
    currentCookie: "iw_sportszone_ds",
    tnkUrl: "?lnk=tnk",
    helpUrl: "help/default/index.php?vert=sporttv",
    privacyUrl: "/privacy.php",
    termsUrl: "/terms.php",
    fbPageId: "146748489247082",
    aliveInterval: 1000*60*60, // 1 hour
    omniboxText: "sporttv for ",
    omniboxResetText: "<url><match>Search sporttv</match></url>",
    omniboxLetter: "s",
	searchType: "sporttv",
    isHub: "false"
};
    ...
    onInstall: function () {
        chrome.runtime.onInstalled.addListener(function (data) {
            if (data["reason"] == "install") {
                ...
                chrome.alarms.create("alive", { periodInMinutes: 1440 });
...
function getCleanCID() {

    var cid = localStorage["cid"] ? localStorage["cid"] : config.defCid;
    try {
        cid = cid.split("_")[0];
    } catch (e) {
        cid = cid;
