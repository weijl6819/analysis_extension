...
function populateOffers() {
    ...
    for (var i = 0; i < offers.length; i++) {
        ...
        items = "<div class='badger-left inline-block' data-badger='Detected Video'><div class='videothumbcontainer inline-block'>" +
            ("<img width='123' height='123' class='videothumb inline-block' src='" + urls.apiUrl + item.image + "'><br />");
        items += "<div class='buttonsContainer'><p style='color: #fff; font-size: 16px; padding: 3px;'>"+item.title+"</p></div>";
