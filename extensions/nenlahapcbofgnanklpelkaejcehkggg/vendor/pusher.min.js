...
(function() {
  function b(a, d) {
    (null === a || void 0 === a) &&
      b.warn('Warning', 'You must pass your app key when you instantiate Pusher.');
    d = d || {};
    var c = this;
    this.key = a;
    this.config = b.Util.extend(
      b.getGlobalConfig(),
      d.cluster ? b.getClusterConfig(d.cluster) : {},
      d
    );
    ...
    this.config.disableStats ||
      (this.timelineSender = new b.TimelineSender(this.timeline, {
        host: this.config.statsHost,
        path: '/timeline/v2/jsonp'
      }));
    this.connection = new b.ConnectionManager(
      this.key,
      b.Util.extend(
        {
  ...
  b.warn = function() {
    ...
    window.console &&
      (window.console.warn ? window.console.warn(a) : window.console.log && window.console.log(a));
    b.log && b.log(a);
  };
  b.ready = function() {
    b.isReady = !0;
  ...
  c.subscribeAll = function() {
    for (var a in this.channels.channels)
  ...
  c.isEncrypted = function() {
    return 'https:' === b.Util.getDocument().location.protocol
      ? !0
  ...
  Pusher.Util = {
    ...
    extend: function(b) {
      for (var c = 1; c < arguments.length; c++) {
        ...
        for (d in a)
          b[d] =
            a[d] && a[d].constructor && a[d].constructor === Object
              ? Pusher.Util.extend(b[d] || {}, a[d])
              : a[d];
      }
      return b;
    },
    stringify: function() {
      for (var b = ['Pusher'], c = 0; c < arguments.length; c++)
        'string' === typeof arguments[c]
          ? b.push(arguments[c])
          : void 0 === window.JSON
            ? b.push(arguments[c].toString())
    ...
    getClientFeatures: function() {
      return Pusher.Util.keys(
        Pusher.Util.filterObject({ws: Pusher.WSTransport, flash: Pusher.FlashTransport}, function(
          b
        ) {
  ...
  Pusher.getDefaultStrategy = function(b) {
    return [
      [
        ':def',
        'ws_options',
        {hostUnencrypted: b.wsHost + ':' + b.wsPort, hostEncrypted: b.wsHost + ':' + b.wssPort}
      ],
      ...
      [
        ':def',
        'streaming_manager',
        [':transport_manager', {lives: 2, minPingDelay: 1e4, maxPingDelay: b.activity_timeout}]
      ],
      ...
      [
        ...
        [
          ':sequential',
          ':timeouts',
          [':if', [':is_supported', ':xhr_streaming'], ':xhr_streaming', ':xdr_streaming']
        ]
      ],
      [
        ':def',
        ...
        [
          ':sequential',
          ':timeouts',
          [':if', [':is_supported', ':xhr_polling'], ':xhr_polling', ':xdr_polling']
        ]
      ],
      [
        ':def',
      ...
      [
        ':def',
        'http_fallback_loop',
        [':if', [':is_supported', ':http_loop'], [':http_loop'], [':sockjs_loop']]
      ],
      [
        ':def',
        'strategy',
        [
          ...
          [
            ...
            [
              ...
              [':is_supported', ':ws'],
              b.encrypted
                ? [':best_connected_ever', ':ws_loop', [':delayed', 2e3, [':http_fallback_loop']]]
                : [
                    ':best_connected_ever',
                    ':ws_loop',
...
(function() {
  ...
  a.emit = function(a, b) {
    ...
    if (e && 0 < e.length) for (c = 0; c < e.length; c++) e[c].fn.call(e[c].context || window, b);
  ...
  c.prototype.remove = function(a, b, c) {
    !a && !b && !c
      ? (this._callbacks = {})
      : ((a = a ? ['_' + a] : Pusher.Util.keys(this._callbacks)),
        b || c
          ? Pusher.Util.apply(
              a,
              function(a) {
...
(function() {
  ...
  c.create = function(a) {
    ...
    this[d] = f;
    return {number: d, id: b, name: c, callback: f};
  };
  c.remove = function(a) {
...
(function() {
  ...
  c.send = function(a) {
    ...
    d.script.addEventListener
      ? ((d.script.onerror = function() {
          a.callback(b);
        }),
      ...
      : (d.script.onreadystatechange = function() {
          ('loaded' === d.script.readyState || 'complete' === d.script.readyState) &&
            a.callback(null);
        });
    void 0 === d.script.async && document.attachEvent && /opera/i.test(navigator.userAgent)
      ? ((d.errorScript = document.createElement('script')),
        (d.errorScript.id = a.id + '_error'),
        (d.errorScript.text = a.name + "('" + b + "');"),
        (d.script.async = d.errorScript.async = !1))
      : (d.script.async = !0);
  ...
  c.load = function(a, d, b) {
    ...
    if (c.loading[a] && 0 < c.loading[a].length) c.loading[a].push(b);
      ...
      var e = new Pusher.ScriptRequest(c.getPath(a, d)),
        f = c.receivers.create(function(d) {
          c.receivers.remove(f);
          if (c.loading[a]) {
            var b = c.loading[a];
            delete c.loading[a];
            for (
...
(function() {
  for (var b = String.fromCharCode, c = 0; 64 > c; c++)
  ...
  var a = function(a) {
      ...
      return 128 > d
        ? a
        : 2048 > d
          ? b(192 | (d >>> 6)) + b(128 | (d & 63))
          : b(224 | ((d >>> 12) & 15)) + b(128 | ((d >>> 6) & 63)) + b(128 | (d & 63));
    },
    d = function(a) {
      var d = [0, 2, 1][a.length % 3];
      a =
        (a.charCodeAt(0) << 16) |
        ((1 < a.length ? a.charCodeAt(1) : 0) << 8) |
        (2 < a.length ? a.charCodeAt(2) : 0);
      return [
        'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(a >>> 18),
        'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt((a >>> 12) & 63),
        2 <= d
          ? '='
        ...
        1 <= d
          ? '='
          : 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(a & 63)
      ].join('');
    },
    h =
      window.btoa ||
...
(function() {
  ...
  b.DEBUG = 7;
  c.log = function(a, d) {
    a <= this.options.level &&
      (this.events.push(Pusher.Util.extend({}, d, {timestamp: Pusher.Util.now()})),
      ...
      c = Pusher.Util.extend(
        {
          ...
          cluster: b.options.cluster,
          features: b.options.features,
          timeline: b.events
        },
        b.options.params
      );
...
(function() {
  ...
  b.prototype.send = function(b, a) {
    var d = this;
    d.timeline.isEmpty() ||
      d.timeline.send(function(a, g) {
        var e = new Pusher.JSONPRequest(
            'http' + (b ? 's' : '') + '://' + (d.host || d.options.host) + d.options.path,
            a
          ),
          f = Pusher.ScriptReceivers.create(function(a, b) {
            Pusher.ScriptReceivers.remove(f);
            e.cleanup();
...
(function() {
  ...
  function c(a, b, c) {
    var h = Pusher.Util.map(a, function(a, d, h, g) {
      return a.connect(
        b,
        c(d, g)
      );
  ...
  h.connect = function(b, d) {
    return c(this.strategies, b, function(b, c) {
      return function(h, g) {
        (c[b].error = h)
          ? a(c) && d(!0)
          : (Pusher.Util.apply(c, function(a) {
              a.forceMinPriority(g.transport.priority);
            }),
            d(null, g));
      };
    });
...
(function() {
  ...
  h.connect = function(b, h) {
    ...
    if (k && k.timestamp + this.ttl >= Pusher.Util.now()) {
      ...
      n &&
        (this.timeline.info({cached: !0, transport: k.transport, latency: k.latency}),
        l.push(new Pusher.SequentialStrategy([n], {timeout: 2 * k.latency + 1e3, failFast: !0})));
    }
      ...
      p = l.pop().connect(
        ...
        function s(a, k) {
          if (a)
            ...
            if (r)
              try {
                r[c(f)] = JSON.stringify({timestamp: Pusher.Util.now(), transport: n, latency: t});
              } catch (u) {}
            h(null, k);
          }
        }
...
(function() {
      ...
      l = function(n, m) {
        m
          ...
          : ((e += 1),
            c.loop && (e %= g.length),
            e < g.length
              ? (f && ((f *= 2), c.timeoutLimit && (f = Math.min(f, c.timeoutLimit))),
                (k = c.tryStrategy(g[e], a, {timeout: f, failFast: c.failFast}, l)))
              : b(!0));
      },
      k = this.tryStrategy(g[e], a, {timeout: f, failFast: this.failFast}, l);
    return {
      abort: function() {
        k.abort();
      },
  ...
  c.tryStrategy = function(a, b, c, g) {
    var e = null,
      f = null;
    0 < c.timeout &&
      (e = new Pusher.Timer(c.timeout, function() {
        f.abort();
        g(!0);
      }));
    f = a.connect(
      b,
      function(a, b) {
        if (!a || !e || !e.isRunning() || c.failFast) e && e.ensureAborted(), g(a, b);
      }
    );
    return {
      abort: function() {
...
(function() {
  ...
  function c(a, b) {
    ...
    return {abort: function() {}, forceMinPriority: function() {}};
  }
  var a = b.prototype;
  ...
  a.connect = function(a, b) {
    ...
    var g = this,
      ...
      k = null,
      l = function() {
        f.unbind('initialized', l);
        f.connect();
      },
      n = function() {
        k = new Pusher.Handshake(f, function(a) {
          e = !0;
          q();
          b(null, a);
        });
      ...
      p = function() {
        q();
        b(new Pusher.Errors.TransportClosed(f));
      },
      q = function() {
        f.unbind('initialized', l);
        f.unbind('open', n);
    ...
    return {
      abort: function() {
        e || (q(), k ? k.close() : f.close());
      },
      forceMinPriority: function(a) {
        e || (g.priority < a && (k ? k.close() : f.close()));
      }
    };
  };
...
(function() {
  function b(a, b, c) {
    return (
      a + (b.encrypted ? 's' : '') + '://' + (b.encrypted ? b.hostEncrypted : b.hostUnencrypted) + c
    );
  }
  function c(a, b) {
    return (
      '/app/' +
      a +
      ('?protocol=' + Pusher.PROTOCOL + '&client=js&version=' + Pusher.VERSION + (b ? '&' + b : ''))
    );
  }
  Pusher.URLSchemes = {
    ws: {
...
(function() {
  ...
  c.initialize = function() {
    ...
    a.hooks.beforeInitialize && a.hooks.beforeInitialize.call(a);
    if (a.hooks.isInitialized()) a.changeState('initialized');
    else if (a.hooks.file)
      a.changeState('initializing'),
        Pusher.Dependencies.load(a.hooks.file, {encrypted: a.options.encrypted}, function(b, c) {
  ...
  c.onClose = function(a) {
    a
      ? this.changeState('closed', {code: a.code, reason: a.reason, wasClean: a.wasClean})
...
(function() {
  ...
  c.createConnection = function(a, b, c, g) {
    return new Pusher.TransportConnection(this.hooks, a, b, c, g);
  };
  Pusher.Transport = b;
}.call(this));
(function() {
  ...
  Pusher.FlashTransport = new Pusher.Transport({
    ...
    isSupported: function() {
      try {
        ...
        try {
          ...
          return Boolean(
            b && b.mimeTypes && void 0 !== b.mimeTypes['application/x-shockwave-flash']
          );
        } catch (c) {
          return !1;
        }
    ...
    beforeInitialize: function() {
      void 0 === window.WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR &&
        (window.WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR = !0);
      window.WEB_SOCKET_SWF_LOCATION =
        Pusher.Dependencies.getRoot({encrypted: this.options.encrypted}) + '/WebSocketMain.swf';
    },
    isInitialized: function() {
  ...
  var b = {
    ...
    a = {file: 'xhr', isSupported: Pusher.Util.isXHRSupported},
    d = {
      file: 'xdr',
...
(function() {
  ...
  c.createConnection = function(a, b, c, g) {
    var e = this;
    g = Pusher.Util.extend({}, g, {activityTimeout: e.pingDelay});
    var f = e.transport.createConnection(a, b, c, g),
      k = null,
      l = function() {
        f.unbind('open', l);
        f.bind('closed', n);
      ...
      n = function(a) {
        f.unbind('closed', n);
        1002 === a.code || 1003 === a.code
          ? e.manager.reportDeath()
          : !a.wasClean &&
            k &&
            ((a = Pusher.Util.now() - k),
            a < 2 * e.maxPingDelay &&
              (e.manager.reportDeath(), (e.pingDelay = Math.max(a / 2, e.minPingDelay))));
      };
    f.bind('open', l);
    return f;
  };
  ...
  function a(a, b) {
    if ('string' === typeof a[0] && ':' === a[0].charAt(0)) {
      ...
      if (1 < a.length) {
        ...
        var e = [Pusher.Util.extend({}, b)].concat(
          Pusher.Util.map(a.slice(1), function(a) {
  ...
  var h = {
    ...
    e = {
      ...
      def_transport: function(a, b, c, d, e, p) {
        ...
        c =
          (!a.enabledTransports || -1 !== Pusher.Util.arrayIndexOf(a.enabledTransports, b)) &&
          (!a.disabledTransports || -1 === Pusher.Util.arrayIndexOf(a.disabledTransports, b)) &&
          ('flash' !== b || !0 !== a.disableFlash)
            ? new Pusher.TransportStrategy(
                b,
                d,
                p ? p.getAssistant(q) : q,
                Pusher.Util.extend(
                  {
                    key: a.key,
...
(function() {
  Pusher.Protocol = {
    ...
    processHandshake: function(b) {
      ...
      if ('pusher:error' === b.event)
        return {action: this.getCloseAction(b.data), error: this.getCloseError(b.data)};
      throw 'Invalid handshake';
    },
    getCloseAction: function(b) {
      return 4e3 > b.code
        ? 1002 <= b.code && 1004 >= b.code
          ? 'backoff'
          : null
        : 4e3 === b.code
          ? 'ssl_only'
    ...
    getCloseError: function(b) {
      return 1e3 !== b.code && 1001 !== b.code
        ? {type: 'PusherError', data: {code: b.code, message: b.reason || b.message}}
        : null;
    }
  };
}.call(this));
    ...
    a.onMessage = function(b) {
      ...
      try {
        ...
        'connected' === c.action
          ...
          : (a.finish(c.action, {error: c.error}), a.transport.close());
      } catch (g) {
        a.finish('error', {error: g}), a.transport.close();
      }
    };
...
(function() {
  ...
  c.startConnecting = function() {
    var a = this,
      b = function(c, g) {
        c
          ? (a.runner = a.strategy.connect(
              0,
              b
            ))
          : 'error' === g.action
            ? (a.emit('error', {type: 'HandshakeError', error: g.error}),
              a.timeline.error({handshakeError: g.error}))
            : (a.abortConnecting(), a.handshakeCallbacks[g.action](g));
      };
    a.runner = a.strategy.connect(
      0,
      b
  ...
  c.resetActivityCheck = function() {
    var a = this;
    a.stopActivityCheck();
    a.connection.handlesActivityChecks() ||
      (a.activityTimer = new Pusher.Timer(a.activityTimeout, function() {
        a.sendActivityCheck();
      }));
  };
  ...
  c.buildHandshakeCallbacks = function(a) {
    ...
    return Pusher.Util.extend({}, a, {
      connected: function(a) {
        b.activityTimeout = Math.min(
          b.options.activityTimeout,
          a.activityTimeout,
          a.connection.activityTimeout || Infinity
        );
  ...
  c.updateState = function(a, b) {
    ...
    this.state = a;
    c !== a &&
      (Pusher.debug('State changed', c + ' -> ' + a),
      this.timeline.info({state: a, params: b}),
      this.emit('state_change', {previous: c, current: a}),
      this.emit(a, b));
  };
...
(function() {
  ...
  c.each = function(a) {
    var b = this;
    Pusher.Util.objectApply(b.members, function(c, g) {
      a(b.get(g));
    });
  };
...
(function() {
  ...
  c.trigger = function(a, b) {
    if (0 !== a.indexOf('client-'))
      throw new Pusher.Errors.BadEventName("Event '" + a + "' does not start with 'client-'");
  ...
  c.handleEvent = function(a, b) {
    0 === a.indexOf('pusher_internal:')
      ? 'pusher_internal:subscription_succeeded' === a &&
        ((this.subscribed = !0), this.emit('pusher:subscription_succeeded', b))
      : this.emit(a, b);
  };
  c.subscribe = function() {
    ...
    a.authorize(a.pusher.connection.socket_id, function(b, c) {
      b
        ? a.handleEvent('pusher:subscription_error', c)
        : a.pusher.send_event('pusher:subscribe', {
            auth: c.auth,
    ...
    Pusher.PrivateChannel.prototype.authorize.call(c, a, function(a, e) {
      if (!a) {
        if (void 0 === e.channel_data) {
          Pusher.warn(
            "Invalid auth response for channel '" + c.name + "', expected 'channel_data' field"
          );
          b('Invalid auth response');
          return;
        }
        var f = JSON.parse(e.channel_data);
        c.members.setMyID(f.user_id);
      }
      b(a, e);
    });
  };
...
(function() {
  ...
  c.add = function(a, b) {
    if (!this.channels[a]) {
      ...
      g =
        0 === a.indexOf('private-')
          ? new Pusher.PrivateChannel(a, b)
          : 0 === a.indexOf('presence-')
            ? new Pusher.PresenceChannel(a, b)
            : new Pusher.Channel(a, b);
      c[a] = g;
    }
  ...
  Pusher.Channel.Authorizer.prototype = {
    composeQuery: function(b) {
      ...
      for (var a in this.authOptions.params)
        b += '&' + encodeURIComponent(a) + '=' + encodeURIComponent(this.authOptions.params[a]);
      return b;
    },
  ...
  Pusher.authorizers = {
    ...
    jsonp: function(c, a) {
      ...
      g.src =
        ...
        '?callback=' +
        encodeURIComponent("Pusher.auth_callbacks['" + d + "']") +
        '&' +
        this.composeQuery(c);
