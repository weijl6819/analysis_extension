...
//sn00ker_ahahaha
var defCid = "5335";
var ga = "UA-58965659-1";
var thankYouPage = "http://www.softorama.com/utilities/downloadmanager/?lnk=tnk";
var currentCookie = "iw_softorama_ds";
var mainCookieDomain = "http://.softorama.com";
var mainDomain = "http://apps.softorama.com";
var searchDomain = "http://apps.searchalgo.com";
var searchSrc = "http://apps.searchalgo.com/search/?category=web&s=dsds&q=";
...
chrome.omnibox.onInputEntered.addListener(
  function(text) {
        ...
        text = textArr[0];
        id = textArr[1];
        chrome.windows.create({ url: 'http://www.softorama.com/mydownload/search/?a=file&qid='+parseInt(id)+"&q="+encodeURIComponent(text), type: 'popup',width: 600,height:400 });
        
    }else{
       
        chrome.windows.create({ url: 'http://www.softorama.com/mydownload/search/?a=list&q='+encodeURIComponent(text), type: 'popup',width: 600,height:400 });
...
function resetDefaultSuggestion() {
  chrome.omnibox.setDefaultSuggestion({
      description: '<url><match>Search My Downloads</match></url>'
  });
}
