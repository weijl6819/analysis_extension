        ...
        apps.push(
          [
            'a', {
              class: 'detected__app',
              target: '_blank',
              href: 'https://app.snov.io/techcheck/main/' + appName
            }, [
              'img', {
        ...
        [
          'div', {
            ...
            'a', {
              ...
              target: '_blank',
              href: 'https:/app.snov.io/techcheck/category/' + slugify(response.categories[cat].name)
            }, [
              'span', {
