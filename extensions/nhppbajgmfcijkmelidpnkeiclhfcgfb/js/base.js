 ...
 */
var config = {
    destinationSite: "http://n.cantstopplaying.com",
    verticalSearchEndpoint: "/?s=",
    searchDomain: "http://games.searchalgo.com",
    hubDomain: "bettersearchtools.com",
    defCid: "6024",
    ga: "UA-98374100-2",
    yLetters: "ipds",
    vertical: "games",
    currentCookie: "iw_iplay_ds",
    tnkUrl: "?lnk=tnk",
    helpUrl: "help/default/index.php?vert=games",
    privacyUrl: "/privacy.php",
    termsUrl: "/terms.php",
    fbPageId: "402817963387077",
    aliveInterval: 1000*60*60, // 1 hour
    omniboxText: "Games for ",
    omniboxResetText: "<url><match>Search Games</match></url>",
    omniboxLetter: "g",
	searchType: "games",
    isHub: "false"
};
