...
run();
//sn00ker_ahahaha
(function() {(function(){function g(){var a={action:"cnt:jiveBind"};if(!("undefined"==typeof chromeUnloading?0:chromeUnloading))c||(c=chrome.runtime.connect({name:d+Date.now()+("undefined"==typeof chromeId?"":chromeId)}),c.onMessage.addListener(function(b){"string"==typeof b&&(b=JSON.parse(b));var a=e[d+b._aC];delete e[d+b._aC];if(a)return a(b);console.log("JIVE",b);a=document.createEvent("CustomEvent");a.initCustomEvent("jabber.presence",!0,!0,b);document.dispatchEvent(a)})),f++,e[d+f]=void 0,a._aC=f,c.postMessage(a)}
