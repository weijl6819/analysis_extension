 ...
 */
var config = {
    destinationSite: "http://wow.gomovix.com",
    verticalSearchEndpoint: "/search?q=",
    searchDomain: "http://movix.searchalgo.com",
    hubDomain: "wowmovix.com",
    defCid: "5771",
    ga: "UA-71931994-2",
    yLetters: "wmdp",
    vertical: "movies",
    currentCookie: "iw_wowmovix_dp",
    tnkUrl: "?lnk=tnk",
    helpUrl: "help/plus/movies/index.php",
    privacyUrl: "/privacy.php",
    termsUrl: "/terms.php",
    fbPageId: "638240243014890",
    aliveInterval: 1000 * 60 * 60, // 1 hour
    omniboxText: "Movies for ",
    omniboxResetText: "<url><match>Search Movies</match></url>",
    omniboxLetter: "m",
    searchType: "movies"
};
