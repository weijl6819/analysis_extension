...
import getToken = chrome.enterprise.platformKeys.getToken;
...
export class AuthenticationService implements common.IAuthenticationService {

    public signin(interactiveSignIn:boolean = false): Promise<any> {
    ...
    public signout(token:any): Promise<string> {
        return new Promise((resolve, reject) => {
            return new Promise((resolve, reject) => {
                chrome.identity.launchWebAuthFlow({ url: `https://www.facebook.com/logout.php?access_token=${token}&next=https://facebook.com`, interactive: true }
                , (responseUrl) => { });
    ...
    public shareDonation(newsLink: string): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            ...
            function onUpdate(tabId: any, changeInfo: any, tab: any) {
