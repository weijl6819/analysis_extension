/*********************************************
* YouTube official library downloaded from https:/s.ytimg.com/yts/jsbin/www-widgetapi-vfl4Pu_oL/www-widgetapi.js on 16/Oct/2017 (SGT).
* It is beautified by http://jsbeautifier.org/ to help extension reviewr to review it.
**********************************************/
(function() {
    var g, k = this;
    ...
    var wa = C("Opera"),
        D = C("Trident") || C("MSIE"),
        xa = C("Edge"),
        E = C("Gecko") && !(-1 != B.toLowerCase().indexOf("webkit") && !C("Edge")) && !(C("Trident") || C("MSIE")) && !C("Edge"),
        ya = -1 != B.toLowerCase().indexOf("webkit") && !C("Edge");
    ...
    function Fa(a) {
        ua(a, function() {
            for (var b = 0, c = ga(String(Ea)).split("."), d = ga(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                var h = c[f] || "",
                    m = d[f] || "";
                do {
                    h = /(\d*)(\D*)(.*)/.exec(h) || ["", "", "", ""];
                    ...
                    b = x(0 == h[1].length ? 0 : parseInt(h[1], 10), 0 == m[1].length ? 0 : parseInt(m[1], 10)) || x(0 == h[2].length, 0 == m[2].length) || x(h[2], m[2]);
                    h = h[3];
                    m = m[3]
                } while (0 == b)
            }
    ...
    function Ka(a) {
        ...
        if (a) {
            ...
            for (c = d = 0; b = f[c]; c++) {
                var h = b.className,
                    m;
                if (m = "function" == typeof h.split) m = 0 <= oa(h.split(/\s+/), a);
                m && (e[d++] = b)
            }
            e.length = d;
            return e
    ...
    function cb(a, b, c) {
        if ("array" == p(b))
            for (var d = 0; d < b.length; d++) cb(a, String(b[d]), c);
    ...
    function jb(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in J ? J.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), gb("ERRORS", c))
    };
    ...
    function M(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[sb(b)] : a.getAttribute("data-" + b) : null
    }
    ...
    function N(a, b, c) {
        ...
        if (a = r(a) ? b.getElementById(a) : a)
            if ("iframe" != a.tagName.toLowerCase() && (b = yb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[t] || (b[t] = ++ca), a.id = "widget" + b), L[this.a.id] = this, window.postMessage) {
                this.f = new H;
                zb(this);
                a = O(this.b, "events");
                for (var d in a) a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
                for (var e in ub) Ab(this,
                    e)
            }
    }
    g = N.prototype;
    ...
    g.C = function(a) {
        ...
        for (c = 0; c < b.length; c++) try {
            ...
            if (m.name && "SyntaxError" == m.name) jb(m, "WARNING");
            else throw m;
        }
    };
    var R = "StopIteration" in k ? k.StopIteration : {
    ...
    W.prototype.g = function(a) {
        if (a.origin == O(this, "host") || a.origin == O(this, "host").replace(/^http:/, "https:")) {
            ...
            if (a = P[b.id]) a.B = !0, a.B && (y(a.w, a.C, a), a.w.length = 0), a.J(b)
        }
    };
    ...
    g.V = function() {
        var a = O(this.b, "host") + this.o(),
            b = '<iframe width="' + parseInt(O(this.b, "width"), 10) + '" height="' + parseInt(O(this.b, "height"), 10) + '" src="';
        na.test(a) && (-1 != a.indexOf("&") && (a = a.replace(ha, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(ia, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(ja, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(ka, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(la, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(ma, "&#0;")));
